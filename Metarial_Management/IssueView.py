...
def EditDeleteIssueProductRecord(request):
    ...
    if(btn == "Edit"):
        ...
        try:
            dbe, cmd = Pool.ConnectionPool()
            q = "update issue set employeeid = {}, categoryid = {}, subcategoryid = {}, productid = {}, finalproductid = {}, demand_employeeid = {}, dateissue = '{}', qtyissue = {}, remark = '{}' where issueid={}".format(employeeid, categoryid, subcategoryid, productid, finalproductid, demand_employeeid ,dateissue, qtyissue, remark, issueid)
            print(q)
            cmd.execute(q)
            dbe.commit()
            row = cmd.fetchone()
